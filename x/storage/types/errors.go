...
var (
	...
	ErrNotEnoughActiveProviders = sdkerrors.Register(ModuleName, 1118, "Cannot find enough active providers")
	ErrContractExists           = sdkerrors.Register(ModuleName, 1119, "Contract already exists")
	ErrDurationTooShort         = sdkerrors.Register(ModuleName, 1120, "Duration too short")
)
